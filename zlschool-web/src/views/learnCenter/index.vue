<template>
  <div class="examCenter">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="left">
        <ListTitle :has-more="false" title="学习详情"/>
        <div id="chart1" class="chart1"/>
      </div>
      <div class="right">
        <ListTitle :has-more="false" title="学习进度"/>
        <div class="r-box">
          <div class="box1">
    ...
    <div class="card">
      <ListTitle :has-more="false" title="学习情况"/>
      <div class="chart-box">
        <div class="left">
          <div id="chart3"/>
        </div>
    ...
    <div class="card">
      <ListTitle :has-more="false" title="学习计划"/>
      ...
      <div class="recordtable">
        <el-table :data="list" border stripe class="table">
          ...
          <el-table-column label="学习主题" align="center">
            <template slot-scope="scope">
              <span>{{ scope.row.a }}</span>
            </template>
          </el-table-column>
