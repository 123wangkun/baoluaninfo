...
@Data
public class AddCourseOnlineReq {
    ...
    @ApiModelProperty(value = "课程状态(1已发布;2未发布)",required = true)
    ...
    private List<OnlineLabelList> labelIds;
    @Data
    public static class OnlineLabelList{
