package com.zl.school.business.common.mybatis;
...
public class CodeGenerator {
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://47.103.34.200:3306/zlschool_test?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    private static final String DRIVER_NAME = "com.mysql.jdbc.Driver";
    // 数据库用户名
    private static final String USERNAME = "root";
    // 数据库密码
    private static final String PASSWORD = "baoluan@2019";
    // @author 值
    private static final String AUTHOR = "南京深卡网络技术有限公司";
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "com.zl.school.business";
    // xml 文件模板
    private static final String XML_MAPPER_TEMPLATE_PATH = "generator/templates/original.xml";
    // mapper 文件模板
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setModuleName("templates");
        packageConfig.setModuleName("templates");
        ...
        strategy.setTablePrefix(new String[]{"t_sys_", "t_"});
